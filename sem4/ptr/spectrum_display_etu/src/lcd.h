...
/* Description: low level function. Allows to directly copy 16 bits word bytes to a window
 *              into the screen defined by its bounds (x0,y0) and (x1,y1)
 * Parameter: x0, y0 top left coordinates of the window
 *            x1, y1 bottom right coordinates of the window
 */
