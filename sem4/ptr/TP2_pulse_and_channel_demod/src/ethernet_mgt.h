 ...
 *              Note that transfer from ROM do not work neither.
 ...
 *      double_len_tx: maximum length of the transmission double buffers (max 2047*2)
 *      double_len_rx: maximum length of the receiving double buffers (max 2047*2)
